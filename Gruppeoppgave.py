...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  1 13:06:13 2024
...
# Nå har vi dataene i lister. Eksempelvis:
# tidspunkt_fil1[2] og temperatur[2] refererer til data på samme tidspunkt.
# tidspunkt_fil2[2] og luftfuktighet[2] gjør det samme.
